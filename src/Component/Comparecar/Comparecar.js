...
const Comparing = () => {
    ...
    const comparecar = () => {
        ...
        const paraa = document.getElementById("para");
        state.Comparecar.map((e, i) => {
            console.log(e.compareboo, e.id, e.carsdetail);
            return (e.carsdetail === undefined && e.compareboo === false) ? paraa.innerHTML = "please select a car" :nav('/comparedetail')
